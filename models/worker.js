...
module.exports = function(sequelize, DataTypes) {
    var Worker = sequelize.define('Worker', {
        ...
        birthday_at: {
            ...
            get: function() {return utils.getTimestamp(this,'birthday_at');}
        },
        email: {
            type:DataTypes.STRING(150), 
            allowNull:false,
        ...
        startup_at: {
            ...
            get: function() {return utils.getTimestamp(this,'startup_at');}
        },
        salary: {
        ...
        getterMethods: {
            ...
            deleted_at: function() {return utils.getTimestamp(this,'deleted_at');}
        }
    });
    return Worker;
};